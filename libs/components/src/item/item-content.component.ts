...
@Component({
  ...
  host: {
    class:
       ...
       */
      "tw-outline-none tw-text-main hover:tw-text-main tw-no-underline hover:tw-no-underline tw-text-base tw-py-2 tw-ps-4 tw-pe-2 bit-compact:tw-py-1.5 bit-compact:tw-ps-2 bit-compact:tw-pe-0 tw-bg-transparent tw-w-full tw-border-none tw-flex tw-gap-4 tw-items-center tw-justify-between",
    "data-fvw-target": "",
  },
